...
namespace MyNFT.Contracts.MyNFT
{
    public partial class MyNFTService
    {
        ...
        public Task<string> MintRequestAsync(string to, BigInteger tokenId, byte[] data)
        {
        ...
        public Task<TransactionReceipt> MintRequestAndWaitForReceiptAsync(string to, BigInteger tokenId, byte[] data, CancellationTokenSource cancellationToken = null)
        {
            var mintFunction = new MintFunction();
            mintFunction.To = to;
            mintFunction.TokenId = tokenId;
